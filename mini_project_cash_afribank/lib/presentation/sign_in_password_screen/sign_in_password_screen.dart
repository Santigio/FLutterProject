import '../sign_in_password_screen/widgets/sign_in_password_item_widget.dart';
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: SvgPicture.asset(
                                      ImageConstant.img_logowhite1_2,
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                          ...
                          child: Padding(
                            ...
                            child: Obx(
                              () => ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: controller.signInPasswordModelObj
                                    .value.signInPasswordItemList.length,
                                itemBuilder: (context, index) {
                                  SignInPasswordItemModel model = controller
                                      .signInPasswordModelObj
                                      .value
                                      .signInPasswordItemList[index];
                                  return SignInPasswordItemWidget(
                                    model,
                                  );
                                },
                              ),
