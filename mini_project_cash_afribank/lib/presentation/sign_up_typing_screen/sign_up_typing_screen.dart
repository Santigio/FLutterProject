import '../sign_up_typing_screen/widgets/sign_up_typing_item_widget.dart';
...
class SignUpTypingScreen extends GetWidget<SignUpTypingController> {
  @override
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: SvgPicture.asset(
                                      ImageConstant.img_logowhite1_5,
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                          ...
                          child: Padding(
                            ...
                            child: Obx(
                              () => ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: controller.signUpTypingModelObj.value
                                    .signUpTypingItemList.length,
                                itemBuilder: (context, index) {
                                  SignUpTypingItemModel model = controller
                                      .signUpTypingModelObj
                                      .value
                                      .signUpTypingItemList[index];
                                  return SignUpTypingItemWidget(
                                    model,
                                  );
                                },
                              ),
